...
# changed by me to customize the prompt
PS1="\[\033[0;31m\]\u@\h \W\$\[\033[0m\] "
export PS1

# i tried try to add permanent aliases
alias drop='cd /home/yannik/Dropbox'
alias desk='cd /home/yannik/Desktop'


# FOR REFERENCE - CAN BE USED ON OTHER MACHINES ($HOME)
...
#rename files such that they have the following format: my-example-file.extension
alias rnme="rename -v \"s/[\[\]()\@']//g; s/[ _]/-/g; y/A-Z/a-z/\""
# rename uses perl expressions
# s/[\[\]()\@']//g      <--- remove these characters: []()@'
# s/[ _]/-/g            <--- substitute space and _ by -
# y/A-Z/a-z/            <--- convert everthing to lowercase
